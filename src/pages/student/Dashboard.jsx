...
const StudentDashboard = () => {
    const { user } = useAuth();
    const { getStudentRequest, updateRequestStatus, refreshRequests, submitAIFeedback, loading: dataLoading } = useData();
    ...
    const handleSubmitResponse = async () => {
        ...
        try {
            ...
            setAiError({
                message: errorMsg,
                originalText: responseMessage,
                context: "Réponse à un donateur (Étudiant)"
            });
            setIsReported(false);
        } finally {
            setIsSending(false);
